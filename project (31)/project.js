...
function poisonMove()
{
	...
	do
	{
		...
		if (wallArrayX[0] == poisonX -60 && wallArrayY[0] == poisonY  && move == 3)
		{
			
			move = 1;
		}

		if (wallArrayX[0] == poisonX +60 && wallArrayY[0] == poisonY  && move == 4)
		{
		
			move = 1;
		}

		if (wallArrayX[0] == poisonX && wallArrayY[0] == poisonY-60  && move == 2)
		{

			move = 3;
		}

		if (wallArrayX[0] == poisonX && wallArrayY[0] == poisonY+60  && move == 1)
		{

			move = 3;
		}
		
		if (wallArrayX[1] == poisonX -60 && wallArrayY[1] == poisonY  && move == 3)
		{
			
			move = 1;
		}

		if (wallArrayX[1] == poisonX +60 && wallArrayY[1] == poisonY  && move == 4)
		{
		
			move = 1;
		}

		if (wallArrayX[1] == poisonX && wallArrayY[1] == poisonY-60  && move == 2)
		{

			move = 3;
		}

		if (wallArrayX[1] == poisonX && wallArrayY[1] == poisonY+60  && move == 1)
		{

			move = 3;
		}

		if (wallArrayX[2] == poisonX -60 && wallArrayY[2] == poisonY  && move == 3)
		{
			
			move = 1;
		}

		if (wallArrayX[2] == poisonX +60 && wallArrayY[2] == poisonY  && move == 4)
		{
		
			move = 1;
		}

		if (wallArrayX[2] == poisonX && wallArrayY[2] == poisonY-60  && move == 2)
		{

			move = 3;
		}

		if (wallArrayX[2] == poisonX && wallArrayY[2] == poisonY+60  && move == 1)
		{

			move = 3;
		}

		if (wallArrayX[3] == poisonX -60 && wallArrayY[3] == poisonY  && move == 3)
		{
			
			move = 1;
		}

		if (wallArrayX[3] == poisonX +60 && wallArrayY[3] == poisonY  && move == 4)
		{
		
			move = 1;
		}

		if (wallArrayX[3] == poisonX && wallArrayY[3] == poisonY-60  && move == 2)
		{

			move = 3;
		}

		if (wallArrayX[3] == poisonX && wallArrayY[3] == poisonY+60  && move == 1)
		{
		...
		if (wallArrayX[4] == poisonX -60 && wallArrayY[4] == poisonY  && move == 3)
		{
			
			move = 1;
		}

		if (wallArrayX[4] == poisonX +60 && wallArrayY[4] == poisonY  && move == 4)
		{
		
			move = 1;
		}

		if (wallArrayX[4] == poisonX && wallArrayY[4] == poisonY-60  && move == 2)
		{

			move = 3;
		}

		if (wallArrayX[4] == poisonX && wallArrayY[4] == poisonY+60  && move == 1)
		{

			move = 3;
		}

		if (wallArrayX[5] == poisonX -60 && wallArrayY[5] == poisonY  && move == 3)
		{
			
			move = 1;
		}

		if (wallArrayX[5] == poisonX +60 && wallArrayY[5] == poisonY  && move == 4)
		{
		
			move = 1;
		}

		if (wallArrayX[5] == poisonX && wallArrayY[5] == poisonY-60  && move == 2)
		{

			move = 3;
		}

		if (wallArrayX[5] == poisonX && wallArrayY[5] == poisonY+60  && move == 1)
		{
		...
		wallArrayX[0] == poisonX && wallArrayY[0] == poisonY ||
		wallArrayX[1] == poisonX && wallArrayY[1] == poisonY ||
		wallArrayX[2] == poisonX && wallArrayY[2] == poisonY ||
		wallArrayX[3] == poisonX && wallArrayY[3] == poisonY ||
		wallArrayX[4] == poisonX && wallArrayY[4] == poisonY ||
		wallArrayX[5] == poisonX && wallArrayY[5] == poisonY ||
		wallArrayX[6] == poisonX && wallArrayY[6] == poisonY ||
		wallArrayX[7] == poisonX && wallArrayY[7] == poisonY ||
		wallArrayX[8] == poisonX && wallArrayY[8] == poisonY ||
		wallArrayX[9] == poisonX && wallArrayY[9] == poisonY );
